            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 h-16">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link to="/" className="flex items-center text-2xl font-bold">
                        <span className='text-orange-700'>hyphen</span>-Blog
                    </Link>
                    <div className="w-60 flex items-center h-10 lg:order-2">
                        {isLoggedIn ? <> <WriteBlogBtn /> <LogoutBtn /></> : <><Login /><Signup /></>}
                    </div>
                    <div
                        className="justify-between items-center w-full lg:flex lg:w-auto lg:order-1"
                        id="mobile-menu-2"
                    >
                        <ul className="flex flex-grow flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
